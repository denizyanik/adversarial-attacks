...
sf.write('simba/original1.wav', test, 44100)
imageio.imwrite('simba/original_spectrogram1.png', spectrogram_to_image(X_test[0]))
...
sf.write('simba/simba.wav', test, 44100)
