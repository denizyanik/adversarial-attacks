...
def train_network(weights_file="weights.hdf5", classpath="Preproc/Train/",
    epochs=2000, batch_size=20, val_split=0.2, tile=False, max_per_class=0,
    k_fold=1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=1400, type=int, help="Number of iterations to train for")
